...
| `.Codex/skills/attract/` | Codex Skill de proyecto: le dice a un agente cuándo correr `doctor`/`synopsis` (M4, `spec/features/002-attract-skill/`) |
...
- Completar los docs plantilla del bootcamp (`CONVENCION.md`, `baseline.md`,
  `mapeo-mockup-pegasus.md`) — son ejercicios del autor, no tareas de Codex
